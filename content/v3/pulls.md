...
`head`|`string` | Filter pulls by head user or org, repo, and branch name in the format of `userOrOrg/repo:ref-name`. Example: `github/foo:new-script-format`. You can leave out the branch or the repo and branch.
